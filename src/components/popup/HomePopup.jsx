    ...
    <AnimatePresence>
      {open && (
        <motion.div
          ...
          className="fixed bottom-6 left-1/2  z-[9999] w-[calc(100%-2rem)] max-w-[956px] !-translate-x-1/2"
        >
        

          {/* Glassmorphic Capsule Body */}
          <div className="relative flex flex-col sm:flex-row items-center justify-between gap-4  rounded-lg w-full  border !border-darkVoilet/20 !bg-white/50 p-3 pl-6 pr-4 shadow-xl !backdrop-blur-[4px]">
          
{/* !text-xl sm:text-lg font-bold */}
            {/* Content Text */}
            <p className="z-10 text-center sm:text-left  text-sm  md:text-base font-semibold  text-[#160E38] pr-6 sm:pr-0 popup-font-inter">
              See how enterprises completed 150,000+ hires using Agentic AI at Booth E31, TechHR 2026.
            </p>
