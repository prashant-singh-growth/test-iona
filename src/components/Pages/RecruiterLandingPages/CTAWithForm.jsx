  ...
  return (
    <section className="w-full bg-[#150D37] overflow-hidden">
     <div className="w-full relative py-16 grid place-items-center px-5 md:px-10 slg:px-[60px] lg:px-[90px]">
       <img src="/assets/pages/cta.webp" alt="" className="absolute inset-0 object-contain min-h-[400px] !top-0 hidden lg:block"/>
         <img src="/assets/pages/landingpage/bg-cta-1.png" alt="" className="absolute inset-0 min-w-[1200px] lg:min-w-full lg:max-w-full lg:hidden"/>
