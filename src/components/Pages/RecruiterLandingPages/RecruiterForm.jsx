...
function RecruiterForm() {
 ...
 <script src="https://js-eu1.hsforms.net/forms/embed/146385824.js" defer></script>
   ...
   const formId = "01dda26d-68dd-4c76-8687-6af6081190f9";
   ...
   return (
     <div id="form" className="w-full !scroll-m-36 bg-[#FEFEFD] border-[#C9C9C9] border shadow-[0px_4px_19.1px_0px_#00000040] rounded-lg relative overflow-hidden">
 ...
 <div className="flex flex-col space-y-2">
         ...
         <button
           ...
           className="bg-primary px-5 py-3 font-bold leading-5 text-[14px] text-white flex items-center justify-center gap-2 rounded hover:scale-95 transition duration-150 w-full"
         >
           {status.loading ? "Submitting..." : "Schedule a Demo"}  <svg
                        width="20"
                        height="20"
                        viewBox="0 0 20 20"
                        fill="none"
