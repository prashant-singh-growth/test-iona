...
function ResultSection({headShow = true,pb = true}) {

  return (
    <section className={`w-full bg-white flex flex-col ${pb ? "py-10 lg:py-20":"pt-10 lg:pt-20"} px-5 md:px-10 slg:px-[60px] lg:px-[90px] justify-center items-center space-y-10`}>
        {headShow && (
