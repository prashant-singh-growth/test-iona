            ...
            <div className="w-full max-w-[1280px] grid lg:grid-cols-2 gap-10">
                ...
                <div className="w-full rounded-[24px] relative p-8 border border-[#E2E4EB] gap-5 grid md:grid-cols-[40%_60%] shadow-[0px_20px_60px_-20px_#5445ED73]">
                    ...
                    <div className="w-full flex flex-col">
                        ...
                        <a class="bg-primary px-4 mt-3 py-2.5 font-bold leading-5 md:px-5 md:py-3 w-fit text-[14px] text-white flex flex-row space-x-2 rounded hover:scale-95 ease-in-out duration-150" href="#form"><span>Register & Get Your Copy </span> <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M4.16669 10H15.8334M15.8334 10L10.8334 5M15.8334 10L10.8334 15" stroke="#FCFCFC" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path></svg></a>
                    </div>
                </div>
