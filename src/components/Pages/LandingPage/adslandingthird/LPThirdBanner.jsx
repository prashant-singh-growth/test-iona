...
"></div><p className='text-[12px] text-[#2A2564] font-lora'>People Matters TechHR India 2026 · 6–7 August · New Delhi</p></div>
       ...
       Meet <span class="bg-[linear-gradient(135deg,_#5445ED_0%,_#8771FF_100%)] bg-clip-text text-transparent">iona.ai</span> at People Matters TechHR India 2026
          ...
          <p className='text-lg font-lora text-[#454B69] mt-6 mb-10'>Agentic Intelligence is redefining HR, closing the gap between workforce planning and day-one-ready onboarding. Catch us at TechHR 2026, get the framework behind this shift, and take home a complimentary copy of The <strong>AI-First CHRO</strong>  by Amit Srivastava.</p>
