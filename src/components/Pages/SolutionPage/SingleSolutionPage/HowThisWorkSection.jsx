      ...
      <div className="w-full lg:max-w-[1440px] flex flex-col justify-center items-center">
        ...
        <div className="w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mt-[50px]">
          {howwork.card.map((card, ind) => (
            <div key={ind} className="w-full hover:border-darkVoilet ease-linear duration-150 hover:shadow-lg shadow-sm  bg-[#FFFFFF] flex flex-col gap-3 border border-[#EAEAEA] py-[22px] rounded-[12px] px-5 md:px-8">
