      ...
      <div className="w-full max-w-[1440px] flex flex-col  justify-center items-center space-y-10">
        <div className="flex flex-col  justify-center items-center ">
          <h2 className="text-3xl md:text-4xl lg:text-[40px] lg:leading-[50px] text-white font-bold md:font-semibold text-center ">
           Why Leading Enterprises Choose iona.ai
          </h2>
        </div>
        <div className="w-full grid grid-cols-1 lg:grid-cols-2">
          ...
          <img src="/assets/pages/Alternative/peoplestrong-casestudy.webp"  loading='lazy' alt="Best Enterprise Hiring Solution" className="w-full object-contain order-1 lg:order-2" />
        </div>
      </div>
    </section>
  );
